        ...
        <div class="product product__style--3">
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="product__thumb">
                    <a class="first__img js-switch-page" href="#product" data-product-id="${componentData.id}">
                        <img src="${componentData.image}" alt="${componentData.name}">
                    </a>
                    <a class="second__img animation1 js-switch-page" href="#product" data-product-id="${componentData.id}">
                        <img src="${componentData.image}" alt="${componentData.name}">
                    </a>
                    ...
                    <div class="action">
                        <div class="actions_inner">
                            <ul class="add_to_links">
                                <li>
                                    <a class="js-add-to-cart" href="#" data-product-id="${componentData.id}">
                                ...
                                <li>
                                    <a class="js-add-to-cart-and-switch-page cart" href="#cart" data-product-id="${componentData.id}">
                                ...
                                <li>
                                    <a class="js-quick-view quickview modal-view detail-link" data-toggle="modal" title="Quick View" data-product-id="${componentData.id}" href="#productmodal">
